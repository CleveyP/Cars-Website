...
if($result){
    echo "<h1 id='successful-upload-message'> Success! Your car is now up for sale!</h1>
    <img src='../pictures/car_and_money.jpg' alt='cash and car' id='successful-upload-img' />
    ";
